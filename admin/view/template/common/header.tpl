...
<link href="view/javascript/jquery/datetimepicker/bootstrap-persiandatetimepicker.min.css" type="text/css" rel="stylesheet" media="screen" />
  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://opencartcms.org" target="_blank"><?php echo $text_support; ?></a></li>
      </ul>
    </li>
