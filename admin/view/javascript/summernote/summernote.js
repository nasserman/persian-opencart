  ...
  $.extend($.summernote.lang, {
    'fa-IR': {
	  ...
	  help: {
        ...
        'undo': 'بازگشت به آخرین دستور',
        'redo': 'انجام مجدد آخرین دستور',
        'tab': 'تب',
        'untab': 'بدون تب',
        'bold': 'تنظیم به سبک بولد',
        'italic': 'تنظیم به سبک ایتالیک (کج)',
        'underline': 'تنظیم به سبک زیر خط دار',
        'strikethrough': 'تنظیم به سبک خط خورده',
        'removeFormat': 'حذف سبک',
        'justifyLeft': 'ترازبندی از سمت چپ',
        'justifyCenter': 'ترازبندی از وسط',
        'justifyRight': 'ترازبندی از سمت راست',
        'justifyFull': 'ترازبندی از دو طرف',
        'insertUnorderedList': 'تعویض لیست نامرتب',
        'insertOrderedList': 'تعویض لیست مرتب',
        'outdent': 'بیرون آمدگی در پاراگراف فعلی',
        'indent': 'تورفتگی در پاراگراف فعلی',
        ...
        'linkDialog.show': 'نمایش کادر پیوند'
      },
      history: {
        undo: 'بازگشت به عقب',
        redo: 'رفتن به جلو'
